    ...
    while True:
        ...
        try:
            ...
            if selection == 1:
                ...
                print("Print Min/Avg/Max by Location")
            elif selection == 5:
                print("Print Min/Avg/Max by Property Type")
            elif selection == 6:
...
ID of _labels;  139743124725192
ID of _active_labels;  139743124725264
{'LOCATION': {'Queens', 'Brooklyn', 'Staten Island', 'Manhattan', 'Bronx'}, 'PROPERTY_TYPE': {'Private room', 
'Entire home / apt'}}
{'LOCATION': {'Queens', 'Brooklyn', 'Staten Island', 'Manhattan', 'Bronx'}, 'PROPERTY_TYPE': {'Private room', 
'Entire home / apt'}}
AirBNB
...
Please select an item to toggle or enter a blank line when you are finished. 9
MY SELECTION: 9
