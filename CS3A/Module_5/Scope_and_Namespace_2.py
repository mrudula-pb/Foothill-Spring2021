def my_func():
    ...
    my_nested_func()
    print(f'value of a in my_func after call to my_nested_func: {a}') # a = 13


a = 7
print(f'value of a at module level: {a}') # a = 7
my_func()
print(f'value of a at module level after my_func: {a}') # a = 7