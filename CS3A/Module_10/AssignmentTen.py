...
class DataSet:
    ...
    def display_field_table(self, category: Categories):
        ...
        active_labels_for_category = self._active_labels[category.name]
        #print(active_labels_for_category)
        for label in active_labels_for_category:
            #print("To find Statistics: ", label)
            field_table_stats = self.table_statistics(category, label)
            print(label, field_table_stats)

    def table_statistics(self, row_category: Categories, label: str):
...
def manage_filters(dataset: DataSet, category: Categories):
    """Print a menu-like list of all labels, Indicate which ones are currently active, Allow the user to
    change a label from active to inactive and vice-versa
...
/home/mdot/MyAssignments/venv/bin/python /home/mdot/MyAssignments/CS3A/Module_10/AssignmentTen.py
...
ID of _labels;  140349256089960
ID of _active_labels;  140349256090032
{'LOCATION': {'Brooklyn', 'Bronx', 'Manhattan', 'Queens', 'Staten Island'}, 'PROPERTY_TYPE': {'Private room', 'Entire home / apt'}}
{'LOCATION': {'Brooklyn', 'Bronx', 'Manhattan', 'Queens', 'Staten Island'}, 'PROPERTY_TYPE': {'Private room', 'Entire home / apt'}}
Airbnb
Main Menu
1 - Print Average Rent by Location and Property Type
...
9 - Quit
What is your choice? 4
Brooklyn (50, 118.0, 200)
Bronx (40, 40.0, 40)
Manhattan (98, 143.42857142857142, 196)
Queens (350, 350.0, 350)
Staten Island (70, 70.0, 70)
Airbnb
Main Menu
1 - Print Average Rent by Location and Property Type
2 - Print Minimum Rent by Location and Property Type
...
4 : Queens ACTIVE
5 : Staten Island ACTIVE
Please select an item to toggle or enter a blank line when you are finished. Airbnb
Airbnb
Main Menu
1 - Print Average Rent by Location and Property Type
2 - Print Minimum Rent by Location and Property Type
...
9 - Quit
What is your choice? 5
Private room (70, 97.66666666666667, 125)
Entire home / apt (100, 188.5, 350)
Airbnb
Main Menu
1 - Print Average Rent by Location and Property Type
2 - Print Minimum Rent by Location and Property Type
...
9 - Quit
What is your choice? 4
Manhattan (100, 156.2, 196)
Traceback (most recent call last):
  File "/home/mdot/MyAssignments/CS3A/Module_10/AssignmentTen.py", line 512, in <module>
    main()
  File "/home/mdot/MyAssignments/CS3A/Module_10/AssignmentTen.py", line 431, in main
    menu(air_bnb)
  File "/home/mdot/MyAssignments/CS3A/Module_10/AssignmentTen.py", line 349, in menu
    dataset.display_field_table(Categories.LOCATION)
  File "/home/mdot/MyAssignments/CS3A/Module_10/AssignmentTen.py", line 224, in display_field_table
    field_table_stats = self.table_statistics(category, label)
  File "/home/mdot/MyAssignments/CS3A/Module_10/AssignmentTen.py", line 247, in table_statistics
    raise DataSet.NoMatchingItems
__main__.NoMatchingItems
Queens (350, 350.0, 350)
